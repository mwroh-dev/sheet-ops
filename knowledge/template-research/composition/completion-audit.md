...
- Draft planner coverage is now machine-recorded for all 21 roadmap organisms:
  ten have runtime draft planners and eleven remain explicit-request-only.
...
- Draft synthesis currently covers the first five productization classes,
  ...
  tracking, expense reimbursement claims, and purchase order line-item control.
  The remaining eleven roadmap
